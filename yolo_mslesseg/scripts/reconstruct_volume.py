...
CLI Arguments:
    ...
    --fold_test (int, mutually exclusive with --patient_id)
        Reconstruct volumes for all patients in the indicated fold,
        used as the test set. Required only if k_folds > 1.

    --patient_id (str, mutually exclusive with --fold_test)
        Reconstruct volumes only for the specified patient.
