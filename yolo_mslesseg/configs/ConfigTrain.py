...
class ConfigTrain:
    ...
    Description:
        ...
        Lifecycle: construct for a single (model, fold) pair → call verify_paths()
        to ensure directories exist → run train.py → optionally call clean() to reset.
        One ConfigTrain instance per fold.
    ...
    def _resolve_dataset_paths(self) -> None:
        ...
        if self.single_fold:
            ...
            # YOLO requires all training images in a single flat images/ directory.
            # train_yolo/ and test_yolo/ are temporary aggregations created before
            # training and deleted afterwards — not part of the permanent dataset.
